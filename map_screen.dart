...
class _MapScreenState extends State<MapScreen> {
  ...
  //recherche d'adresse en haut de l'écran pour la convertir en coordonnées GPS.
  TextEditingController destinationController = TextEditingController();
// liste tous les stops de livraison dans l'ordre
  List<DeliveryStop> stops = [];
  // va true if tous les opérations de recherche true
  ...
  // demende gps et latlng et mettre à jour ui
...
// convertir adresse en latlng
  Future<LatLng> getLatLngFromAddress(String address) async {
    List<Location> locations = await locationFromAddress(address);
    return LatLng(locations.first.latitude, locations.first.longitude);
  }
// calculer heure arrivé
  ...
  //vérifier s’il existe déjà un trajet (trip) crée sinon
...
//zoome et dézoome automatiquement pour voir tout le trajet
  void _fitAllRoutes() {
...
// supprimer une station (stop) de la liste + recalculer les routes
  ...
  Widget build(BuildContext context) {
    //garder seulement les stations non livrées
    ...
    return Scaffold(
      ...
      body: currentPosition == null
          ? const Center(child: CircularProgressIndicator())// ← GPS pas encore prêt
          : Stack( // ← carte affichée
        children: [
          ...
          FlutterMap(
            ...
            children: [
              ...
              // PolylineLayer dessine la ligne sur la carte
              PolylineLayer(
                polylines: [
